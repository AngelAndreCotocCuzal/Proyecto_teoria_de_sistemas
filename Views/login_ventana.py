...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setStyleSheet("color: rgb(39, 36, 214);\n"
"background-color: rgb(36, 214, 202);")
        ...
        self.Login_button.setStyleSheet("background-color: rgb(214, 208, 36);\n"
"color: rgb(255, 255, 255);")
        ...
        self.Create_Account_Button.setStyleSheet("background-color: rgb(214, 208, 36);\n"
"color: rgb(255, 255, 255);")
        ...
        self.contrasenia.setMaxLength(12)
        ...
        self.label_4.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0.512, y1:0, x2:0.532, y2:1, stop:0.174129 rgba(36, 214, 202), stop:1 rgba(255, 255, 255, 255));")
        self.label_4.setText("")
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(0, 140, 491, 8))
        self.label_5.setStyleSheet("background-color: qconicalgradient(cx:0.426, cy:0.522727, angle:0, stop:0 rgba(136, 106, 22, 255), stop:0.109453 rgba(166, 140, 41, 255), stop:0.285 rgba(204, 181, 74, 255), stop:0.345 rgba(235, 219, 102, 255), stop:0.415 rgba(245, 236, 112, 255), stop:0.52 rgba(209, 190, 76, 255), stop:0.57 rgba(187, 156, 51, 255), stop:0.635 rgba(168, 142, 42, 255), stop:0.75 rgba(218, 202, 86, 255), stop:0.815 rgba(208, 187, 73, 255), stop:0.950249 rgba(202, 174, 68, 255));")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "Empresa"))
        self.label.setText(_translate("MainWindow", "Empresa de Diana"))
